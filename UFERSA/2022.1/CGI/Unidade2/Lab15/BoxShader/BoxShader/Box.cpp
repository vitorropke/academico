...
void Box::Update()
{
    ...
    // questão 2
    // atualiza o buffer constante com o novo valor do timer
    ObjectVariables objVariables;
    objVariables.gTime = float(sin(timer.Elapsed()));
    memcpy(constantBufferData, &objVariables, sizeof(ObjectVariables));
}
...
void Box::BuildGeometry()
{
    ...
    */
    ...
    XMMATRIX Ry = XMMatrixRotationY(XMConvertToRadians(60));
