...
void Curves::Update()
{
    ...
    if (input->KeyPress(VK_LBUTTON))
    {
        ...
        // Muda a cor das linhas para amarelo quando o contador passar de 10
        if (count < 10)
        ...
        /*
        // Muda a cor das outras linhas quando a contagem de vértices é 10
        if (count == 10)
        {
    ...
    // apaga as linhas desenhadas na tela com o pressionamento da tecla DELETE
