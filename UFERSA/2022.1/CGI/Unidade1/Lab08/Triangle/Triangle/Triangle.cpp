...
void Triangle::Display()
{
    ...
    // Letra d
    graphics->CommandList()->IASetPrimitiveTopology(D3D_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP);
...
void Triangle::BuildGeometry()
{
    ...
    Vertex vertices[4] =
    {
        ...
        { XMFLOAT3(-0.5f, 0.5f, 0.0f), XMFLOAT4(Colors::Orange) },
        { XMFLOAT3(0.5f, 0.5f, 0.0f), XMFLOAT4(Colors::Orange) },
        { XMFLOAT3(-0.5f, -0.5f, 0.0f), XMFLOAT4(Colors::Cyan) },
        { XMFLOAT3(0.5f, -0.5f, 0.0f), XMFLOAT4(Colors::Cyan) }
        */
    };
