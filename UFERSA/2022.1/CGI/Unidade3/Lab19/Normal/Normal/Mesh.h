...
struct SubMesh
{
    uint indexCount = 0;                // quantidade de índices na malha
    uint startIndex = 0;                // posição dos índices no index buffer
    uint baseVertex = 0;                // posição dos vértices no vertex buffer
    
    // topologia da malha de vértices
