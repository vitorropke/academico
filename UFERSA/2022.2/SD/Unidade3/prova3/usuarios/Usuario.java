...
public abstract class Usuario {
	...
	private static ServiceGateway stub;
	...
	public static void executar(String login, String senha) {
		 ...
		 * inserirString();
		 * 
		 * Usuario usuario = null; do { System.out.print("Informe seu login: "); String
		 * login = inserirString(); System.out.print("Informe sua senha: "); String
		 * senha = inserirString(); usuario = Servidor.autenticarUsuario(login, senha);
		 * 
		 * if (usuario == null) { System.err.println("Usuario nao cadastrado!\n"); } }
		 * while (usuario == null);
		 */
		...
		try {
			...
			do {
				...
				case 2:
					...
					String nomeOuRenavamCarro = inserirString();

					Carro carro = stub.pesquisarCarro(nomeOuRenavamCarro);
					if (carro == null) {
