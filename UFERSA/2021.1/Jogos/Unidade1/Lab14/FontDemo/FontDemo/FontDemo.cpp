...
void FontDemo::Init()
{
    ...
    courierNew = new Font("Resources/CourierNew32.png");
    courierNew->Spacing("Resources/CourierNew32.dat");
    //courierNew->Spacing(60);
}
...
void FontDemo::Draw()
{
    ...
    */
    verdana->Draw(60, 345, "Verdana 12", green, Layer::FRONT, 0.75f, -90);
    verdana->Draw(60, 375, "Esta é a fonte Verdana 12 pontos", black, Layer::FRONT, 1.0f, -60);
    verdana->Draw(60, 405, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", blue, Layer::FRONT, 1.25f, -45);
    verdana->Draw(60, 435, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", red, Layer::FRONT, 1.5f, -30);

    courierNew->Draw(200, 200, "Font Demo!", Color(0.23f, 0.77f, 0.14f, 1.0f), Layer::FRONT, 1.0f, -45);
} 
