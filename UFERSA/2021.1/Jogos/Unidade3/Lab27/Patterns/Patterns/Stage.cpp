...
Stage::Stage()
{
    ...
    const int size1 = 11;
    float posicaoXInicial = 100.0f;
    Instruction entrance1[size1] =
    {
        { MOVETO, posicaoXInicial, 0.0f, 5.0f },
        { MOVETO, 10.0f, 100.0, 5.0f },
        { MOVETO, 100.0f, 300.0f, 5.0f },
        { MOVETO, 100.0f, 100.0f, 5.0f },
        { ROTATE, -5.0f, 8.0f, 1.8f },
        { MOVE, 0.0f, 5.0f, 0.3f },
        { MOVETO, 300.0f, 100.0f, 5.0f },
        { MOVE, 270.0f, 0.0f, 0.3f },
    ...
    first[0] = new Alien(ALIEN1, entrance1, size1, posicaoXInicial, 0);
    entrance1[4].angle = 340.0f;
    first[1] = new Alien(ALIEN1, entrance1, size1, posicaoXInicial, -50);
    entrance1[4].angle = 380.0f;
    first[2] = new Alien(ALIEN1, entrance1, size1, posicaoXInicial, -100);
    entrance1[4].angle = 420.0f;
    first[3] = new Alien(ALIEN1, entrance1, size1, posicaoXInicial, -150);
