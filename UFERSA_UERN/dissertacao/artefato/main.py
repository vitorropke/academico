...
def main() -> None:
    ...
    hubs, cycles = optimize_cycles(instance=instance, central_point=central_point, hubs=hubs, cycles=cycles)
    exit(0)
    generate_interactive_map(instance=instance, central_point=central_point, hubs=hubs, cycles=cycles,
                             filepath='outputs/interactive_map.html')
